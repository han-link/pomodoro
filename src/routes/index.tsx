...
export default component$(() => {
    ...
    const selected = useSignal<"pomodoro" | "shortBreak" | "longBreak">("pomodoro");
        ...
        <>
            <main class="flex h-screen w-screen items-center justify-center">
                <div class="flex max-w-lg flex-col items-center">
                    ...
                    <div class="my-5 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        {/* Pomodoro */}
                        <div class="grid grid-rows-2 place-items-center gap-2 w-full">
                            <button
                                type="button"
                                data-ripple-dark="true"
                                onClick$={() => (selected.value = "pomodoro")}
                                disabled={isRunning.value}
                                class="cursor-pointer w-full rounded-lg border border-gray-900/10 px-6 py-3 font-sans text-xs font-bold uppercase select-none bg-white-900
